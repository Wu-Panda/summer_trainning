...
public class Administrator {
    ...
    public static void createGUI() {
        ...
        // 加载背景图片
        ImageIcon backgroundImage = new ImageIcon(Administrator.class.getResource("/MainBackground.jpg")); // 获取图片的位置
        ...
        changePasswordButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    queryStatement.setString(1, LoginAction.id);
                        ...
                        if (!currentPassword.equals(currentDBPassword)) {
                            ...
                            if (newPassword1.equals(newPassword2)) {
                                ...
                                try {
                                    ...
                                    updateStatement.setString(2, LoginAction.id);
