...
class menu{
    ...
    // 写入文本
    void saveExcel(){
        String product_path = "./version3.0/Database/excel/products.csv";
        String admin_path = "./version3.0/Database/excel/administrator.csv";
        String customer_path = "./version3.0/Database/excel/customer.csv";
