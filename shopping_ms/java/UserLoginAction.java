...
public class UserLoginAction {
    ...
    public static void createGUI() {
        ImportDatabase.importDataAndExport();
        ...
        ImageIcon backgroundImage = new ImageIcon(UserLoginAction.class.getResource("/MainBackground.jpg"));
